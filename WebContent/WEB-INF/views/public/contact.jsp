...
<section id="aa-catg-head-banner">
   <img src="${contextPath }/resources/public/img/fashion/fashion-header-bg-8.jpg" alt="fashion img">
           ...
           <div class="aa-contact-address">
             <div class="row">
               <div class="col-md-8">
                 ...
                 <h6 style="color: #F36861; ">${msg }</h6>
                 <form:errors path="obj.*" class="myErrors"  ></form:errors>
                   <form class="comments-form contact-form" method="post" action="${pageContext.request.contextPath }/lien-he" >
                    <div class="row">
                      <div class="col-md-6">
                    ...
                    <button class="aa-secondary-btn" type="submit" value="Submit">Gửi</button>
                  </form>
                 </div>
               </div>
               <div class="col-md-4">
                 <div class="aa-contact-address-right">
                   <address>
                     <h4>BookShop</h4>
                     <p>Cảm ơn bạn đã quan tâm đến Book shop.</p>
                     <p><span class="fa fa-home"></span>Đà Nẵng, Việt Nam</p>
                     <p><span class="fa fa-phone"></span>+ 0397303999</p>
                     <p><span class="fa fa-envelope"></span>Email: ngan@gmail.com </p>
                   </address>
                 </div>
               </div>
             </div>
